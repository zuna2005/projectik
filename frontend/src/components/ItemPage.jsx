      ...
      <div className='d-flex flex-column w-75'>
        <div className="text-center my-4 position-relative">
          ...
          <div className="position-absolute" style={{top: '0px', right: '0px'}}>
            <NavLink to='edit-item' className='btn btn-outline-dark me-2'>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-6 w-75'>
              <h6 className='text-body-secondary'>#id {item.id}</h6>
              ...
              <h5 className='text-body-secondary'>Likes: {item.likes ? item.likes.split(',').length : 0} 
                {user.status == 'Active' && 
                <button className='btn' onClick={handleLike}>{liked ? 
                  <img src={HeartFill} width={25} height={25}/> :
                  <img src={HeartOutline} width={25} height={25}/>
                  }</button>}
              </h5>
              <hr />
